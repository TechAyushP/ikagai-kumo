...
const Widget = () => {
  ...
  const stations = [
    ...
    { name: "93.5Red FM", url: "https://live.cmr24.net/CMR/Desi_Music-MQ/icecast.audio" },
  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: '24rem', margin: '0 auto' }}>
        <h1 style={{ fontSize: '1.875rem', fontWeight: 'bold', marginBottom: '0.75rem', textAlign: 'center' }}>Live Radio</h1>
        ...
        <div style={{ fontSize: '1.5rem', fontWeight: '600', marginBottom: '0.5rem', textAlign: 'center' }}>
        ...
        <div style={{
          ...
          {[0, 0.5, 0.2, 0.75,1.0, 1.5, 1.2, 1.75,2.0, 2.5, 2.2, 2.75,3.0, 3.5, 3.2, 3.75,4.00, 4.5, 4.2, 4.75,5.00,5.5, 5.2, 5.75,6.00].map((delay, index) => (
            <div
              key={index}
              style={{
                animation: currentStation ? `play 1s ease-out infinite` : 'none',
                animationDelay: currentStation ? `${delay}s` : '0s',
                backgroundColor: currentStation ? getRandomColor() : 'transparent',
