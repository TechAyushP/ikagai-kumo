  ...
  return (
    ...
    <div className="weather-container" style={containerStyle}>
      <div className="search-box" style={searchBoxStyle}>
        ...
        />
        <button className="bi bi-search" onClick={handleSearch} style={searchBoxButtonStyle}></button>
      </div>
          ...
          <div className="box">
            <div className="info-weather">
              <div className="weather">
                <img src={`https://i.postimg.cc/NfJV92Ks/cloud.png`} alt="weather icon" style={weatherBoxImgStyle} />
                <p className="temp" style={tempStyle}>
                  {parseInt(weatherData.main.temp)}
                  <span style={tempSpanStyle}>°C</span>
                </p>
                <p className="description" style={descriptionStyle}>{weatherData.weather[0].description}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="wind" style={windStyle}>
            ...
            <div className="text">
              <div className="info-wind">
                <span style={textStyle}>{parseInt(weatherData.wind.speed)}Km/h</span>
              </div>
      ...
      {notFound && (
        <div className="not-found active" style={notFoundStyle}>
          <div className="box">
            <img src="https://i.postimg.cc/C5436vMk/404.png" alt="not found" style={notFoundImgStyle} />
